...
my_big_info = {
    'jdfjg': [983, {7: 44, 0: 444}, {3, 6, 6}],
    'ooioe': {9: [73737, 9393, (3, 5, (3, 4, 3), 3), None, 'sjsksjk']},
    567: 'hihih'
}
with open("my_big_info.pkl", "wb") as f:
    pickle.dump(my_big_info, f)

with open("my_big_info.pkl", 'rb') as f:
    my_big_info_loaded = pickle.load(f)
print(type(my_big_info_loaded), my_big_info_loaded)
